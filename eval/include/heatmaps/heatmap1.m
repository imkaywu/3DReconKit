function [hImage, hText, hXText] = heatmap1(mat1, mat2, xlab, ylab, textmat, varargin)
...
if nargin < 2, error('Heatmap requires at least one input argument'); end
if nargin < 3, xlab = []; end
if nargin < 4, ylab = []; end
if nargin < 5, textmat = []; end

% Parse parameter/value inputs
p = parseInputs(mat1, varargin{:});
