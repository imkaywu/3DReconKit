...
total_number = uint32(total_number); % double to int
...
% fill up voxels table with coordinates, original implementation
% l = 1;
% for z=ez:z_step:sz
% for x=sx:x_step:ex
% for y=sy:y_step:ey
...
% fill up voxels table with coordinates, matrix implementation
voxel(:, 1 : 3) = [voxel3Dx(:) voxel3Dy(:) voxel3Dz(:)];
